...
func Set(path string, value interface{}) JsonModification {
	return func(toModify interface{}) (interface{}, error) {
		...
		case map[string]interface{}:
			...
			return toModify, nil
		case []interface{}:
			return toModify, nil // TODO: complete this (return error if index > len(toModify))
		case nil:
			return toModify, nil // TODO: based on next path segment (or absence thereof), create a map, a slice, or set the value
		default:
			return nil, errors.New("invalid path")
		}
	}
